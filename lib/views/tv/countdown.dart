      ...
      children: [
        Column(
          children: [
            ...
            const Text('Days', style: TextStyle(fontWeight: FontWeight.w300, fontSize: 14, color: Colors.grey),)
          ],
        ),
        ...
        Column(
          children: [
            ...
            const SizedBox(height: 8),
            const Text('Hours', style: TextStyle(fontWeight: FontWeight.w300, fontSize: 14, color: Colors.grey),)
          ],
        ),
        SizedBox(width: MediaQuery.of(context).size.width * .01),
        Column(
          children: [
            ...
            const SizedBox(height: 8),
            const Text('Minutes', style: TextStyle(fontWeight: FontWeight.w300, fontSize: 14, color: Colors.grey),)
          ],
        ),
        SizedBox(width: MediaQuery.of(context).size.width * .01),
        Column(
          children: [
            ...
            const SizedBox(height: 8),
            const Text('Seconds', style: TextStyle(fontWeight: FontWeight.w300, fontSize: 14, color: Colors.grey),)
          ],
        ),
      ],
    );
